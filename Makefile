...
helm.install: helm.dependency-update
	helm install $(releaseName) zeebe-benchmark/zeebe-benchmark --version 0.3.8 --render-subchart-notes --values charts/zeebe-benchmark/values-realistic-benchmark.yaml
